...
##
class NeuronActivationVisualizationModule(ProcessingModule):
...
#        for neuro_leg in self.neuro_walknet.controller_objs:
    #        if (plot_nr < 314):
      #          self.neuronAct_visualization[plot_nr-311] = NeuronActivationLegFigure(neuro_leg, self.fig_activation.add_subplot(plot_nr), self.time_window)
        #    plot_nr += 1
        self.neuronAct_visualization[0] = NeuronActivationLegFigure(neuro_leg, [9,29], self.fig_activation.add_subplot(311), self.time_window) # for FL,0: 29,9,for ML,2: 29,9, for HL,4: 9,29 for FR,1: 9,29,for MR,3: 9,29, for HR,5: 9,29   
        self.neuronAct_visualization[1] = NeuronActivationLegFigure(neuro_leg, [49,69], self.fig_activation.add_subplot(312), self.time_window)
        self.neuronAct_visualization[2] = NeuronActivationLegFigure(neuro_leg, [89,109], self.fig_activation.add_subplot(313), self.time_window)
