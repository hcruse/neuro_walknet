...
from controller.neuro_walknet.NeuroLegMovement import NeuroLegMovement
from controller.neuro_walknet.NeuroCoordinationRules import NeuroCoordinationRules
